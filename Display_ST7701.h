...
#define ESP_PANEL_LCD_WIDTH                       (960)
#define ESP_PANEL_LCD_HEIGHT                      (960)
...
#define ESP_PANEL_LCD_RGB_TIMING_HBP              (20)
#define ESP_PANEL_LCD_RGB_TIMING_HFP              (20)
#define ESP_PANEL_LCD_RGB_TIMING_VPW              (8)
...
#define ESP_PANEL_LCD_RGB_BOUNCE_BUF_SIZE         (7200)  // Bounce buffer size in bytes. This function is used to avoid screen drift.
